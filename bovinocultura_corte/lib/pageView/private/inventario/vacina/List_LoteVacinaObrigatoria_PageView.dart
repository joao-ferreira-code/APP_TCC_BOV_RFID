...
class List_LoteVacinaObrigatoria_PageView extends StatefulWidget {
  const List_LoteVacinaObrigatoria_PageView({Key? key, required this.usuario, required this.fazenda }) : super(key: key);

  final Usuario usuario;
  final Fazenda fazenda;

  @override
  _List_LoteVacinaObrigatoria_PageView createState() => _List_LoteVacinaObrigatoria_PageView();
}

//============================================================================//

class _List_LoteVacinaObrigatoria_PageView extends State<List_LoteVacinaObrigatoria_PageView> {
  ...
  loadLoteVacina() async {
    try{
      ...
      List<LoteVacina> list = await LoteVacinaService.getInstance().
            getAllLoteObrigatorioByFazenda(fkFazenda: widget.fazenda.pkFazenda!);
    ...
    Navigator.push( context,
      MaterialPageRoute(
          builder: (context) => NewLoteVacina_PageView(usuario: widget.usuario,
            fazenda: widget.fazenda, isObrigatoria: true,)),
