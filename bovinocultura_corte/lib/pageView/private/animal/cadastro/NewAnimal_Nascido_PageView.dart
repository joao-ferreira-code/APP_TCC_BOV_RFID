...
import 'package:bovinocultura_corte/clienteService/bovino/BovinoFazendaService.dart';
import 'package:bovinocultura_corte/dataModel/animal/Bovino.dart';
import 'package:bovinocultura_corte/dataModel/animal/BovinoFazenda.dart';
import 'package:bovinocultura_corte/dataModel/animal/CompraBovino.dart';
...
class NewAnimal_Nascido_PageView extends StatefulWidget {
  const NewAnimal_Nascido_PageView({Key? key, required this.usuario, required this.fazenda }) : super(key: key);

  final Usuario usuario;
  final Fazenda fazenda;

  @override
  _NewAnimal_Nascido_PageView createState() => _NewAnimal_Nascido_PageView();
}

//=========================================================================================//

class _NewAnimal_Nascido_PageView extends State<NewAnimal_Nascido_PageView> {
...
//----------------------------------------------------------------------------//
  ...
  @override
  void initState() {
    _dataNascimento.text = DateFormatter.format(dateTime: DateTime.now());
    loadRacas();
  }
          ...
          child: Container(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  ...
                  InputTipo.createInputAreaText(textoConteudo: "Avaliação", variavelArmazenaDado: _avaliacao,
    ...
    if (_formKey.currentState!.validate()){
      try{
        Bovino bovino = new Bovino(fkRaca: racaSelecionada.pkRaca,
          ...
          txAvaliacao: _avaliacao.text, inseminacao: inseminacao == "Monta"?false:true,
        ...
        BovinoFazenda_Cad bovFaz = new BovinoFazenda_Cad(fkFazenda: widget.fazenda.pkFazenda,
            txCodigoEpc: _codeRFID_Animal.text,  bovino: bovino, compraBovino: new CompraBovino() );
        ...
        await BovinoFazendaService.getInstance().createBovinoNascimento(bovino: bovFaz);
