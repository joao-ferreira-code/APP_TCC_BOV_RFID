...
class Resumo_Animal_PageView extends StatefulWidget {
  const Resumo_Animal_PageView({Key? key, required this.usuario, required this.fazenda }) : super(key: key);

  final Usuario usuario;
  final Fazenda fazenda;

  @override
  _Resumo_Animal_PageView createState() => _Resumo_Animal_PageView();
}

//============================================================================//

class _Resumo_Animal_PageView extends State<Resumo_Animal_PageView> {
...
//----------------------------------------------------------------------------//
  ...
  loadResumo() async {
    try{
      ...
      List<dynamic> rs = await BovinoFazendaService.getInstance().
...
//----------------------------------------------------------------------------//
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: Paineis.appBar(context: context, text: ('Resumo Animal'), ),
